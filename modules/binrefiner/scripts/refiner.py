...
# @Last Modified time: 2021-10-28 17:10:54
...
What this script doing is making new bins based on previously done bins. It will conserves only
contigs which were cluster together in the same bin for all binners and remove all resulting new
bins under a specific sequences size sum.
...
- Clean the messy code, use pandas instead of crazy amount of dictionaries
...
def process(binlists, outdir, minsize=524288, decompose=True, ncore=1):
    ...
    if decompose:
        ...
        # We generate result for each combinations
...
if __name__ == '__main__':
    ...
    parser.add_argument('-minsize',
                        ...
                        default=524288,
                        type=int,
                        help='Minimum size (default 524288)')
